...
const CONNECTOR_VERSION =
  '2025-12-08 - tool exclusion sets framework + nexus_anchor_jewels/nexus_weave_enchanted_async sequencing v12';
  ...
  if (context.toolName === 'edit_file') {
    ...
    successContent.push({
      ...
      text:
        ...
        `\nSucceeded: ${succeededCount}, Failed: ${failedCount}, No-op: ${noOpCount}.`,
    });
