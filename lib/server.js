...
function buildAraxisCommand(leftPath, rightPath) {
  ...
  // Escape double quotes for safety inside PowerShell -Command string
  ...
  //   #ARAXIS_SAFE
  //   Start-Process -FilePath 'C:\\...\\Merge.exe' -ArgumentList "E:\\...left.md", "E:\\...right.md"
  //
  // We deliberately wrap each argument in double quotes so the final
  // command line seen by Araxis is:
  //   "Merge.exe" "E:\\...left.md" "E:\\...right.md"
  // which preserves paths with spaces exactly as CMD would.
  const psCommand =
    "#ARAXIS_SAFE\n" +
