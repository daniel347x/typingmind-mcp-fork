...
/**
 * Global stub handler for file I/O tools.
 *
 ...
 *
 * For now this is a no-op so behaviour is unchanged.
 */
async function handleFileIoPreflight(context) {
  // context: { clientId, clientEntry, toolName, toolArgs }
  // TODO (Decade 60+): implement UTF-8 normalization preflight here.
  return context;
}
